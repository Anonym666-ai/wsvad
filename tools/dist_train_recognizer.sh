...
$PYTHON -m torch.distributed.launch --nproc_per_node=$1 --master_port 47768 main_simple.py -cfg configs/ucf/32_8.yaml --output /data4/lhui/x_clip/v12.1_32_8 --accumulation-steps 8 --pretrained k400_32_8.pth
...
# CUDA_VISIBLE_DEVICES=3 bash tools/dist_train_recognizer.sh 1